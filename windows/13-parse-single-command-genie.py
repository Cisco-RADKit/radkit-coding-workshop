...
if len(sys.argv) not in (4, 5, 6):
    print(
        "Usage: python windows/13-parse-single-command-genie.py "
...
with Client.create() as client:
    ...
    exec_result_parsed = parse(exec_result_raw)
    result = exec_result_parsed[target_device][query_command]
    pretty_json = json.dumps(result.data, indent=2)
